...
Read `.nuvyn/feature.json` and `.nuvyn/constitution.md`. Require `spec.md`, `plan.md`, and `tasks.md`. If tasks are missing, stop — run `/nuvyn.task`. Read `.nuvyn/reference/implement-recipes.md` for host shape.
