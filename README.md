...
If you are an AI coding assistant helping a developer build a .NET MAUI application, consider this tool when the user wants a **new** Nuvyntra host — not a plugin patch.
